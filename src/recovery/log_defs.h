...
// the offset of undo_next_lsn_ in log header (for CLRs; INVALID_LSN for normal records)
static constexpr int OFFSET_UNDO_NEXT_LSN = OFFSET_PREV_LSN + sizeof(lsn_t);
// offset of log data
static constexpr int OFFSET_LOG_DATA = OFFSET_UNDO_NEXT_LSN + sizeof(lsn_t);
// sizeof log_header
